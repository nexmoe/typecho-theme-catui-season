...
<section class="catui-item" id="sider-copyright">
    <div class="sider-content">
        &copy; <?php echo date("Y"); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php echo $this->options->title(); ?></a><br>Theme By <a href="https://github.com/theme-catui/typecho-theme-catui-seasons" target="_blank">Cat UI Seasons</a>
    </div><!-- .sider-content -->
